...
- Suitable for Sonnet:
  > Complexity: low–medium — Sonnet is sufficient.
  > Currently running on Opus. To proceed more efficiently:
  > Re-run with the /brainstorm command.
  >
  > Shall we continue, or would you like to switch models?

- Suitable for Opus:
  > Complexity: high — Proceeding with Opus.
...
```
# Suitable for Sonnet (single feature or implementation choice comparison — /brainstorm recommended)
...
# Suitable for Opus (architecture, multi-domain, hard-to-reverse decisions)
